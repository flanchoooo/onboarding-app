        ...
        <div class="card">
            ...
            <section id="view-home" class="view active">
                ...
                <div class="menu-buttons">
                    ...
                    <button class="btn btn-outline" id="btn-register">
                        ✍️ Register Manually
                    </button>
                </div>
            </section>
...
<script>
    ...
    // Simulate a QR scan then go to register page
    document.getElementById("btn-scan").addEventListener("click", function () {
        // In a real app, you would trigger a camera/QR scanner here.
        // For this demo, we just show the registration form.
        showView("view-register");
        alert("QR scanned successfully. Please complete your registration details.");
    });
